...
[drf-yasg2][drf-yasg2] (an active fork of generates of [drf-yasg2][drf-yasg2]) [OpenAPI][open-api]
documents suitable for code generation - nested schemas, named models, response bodies,
enum/pattern/min/max validators, form parameters, etc.
...
customizability and client generation. It's usage patterns are very similar to [drf-yasg2][drf-yasg2].
