...
class AttributeMappingOnAutogeneratedFieldsTests(TestCase):
    ...
    def test_char_field(self):
        self.check_field('char_field')

    def test_comma_separated_integer_field(self):
        self.check_field('comma_separated_integer_field')

    def test_decimal_field(self):
        self.check_field('decimal_field')

    def test_email_field(self):
        self.check_field('email_field')

    def test_file_field(self):
        self.check_field('file_field')

    def test_image_field(self):
        self.check_field('image_field')

    def test_slug_field(self):
        self.check_field('slug_field')

    def test_url_field(self):
        self.check_field('url_field')
...
class DefaultValuesOnAutogeneratedFieldsTests(TestCase):
    ...
    def test_positive_integer_field(self):
        self.check_field('positive_integer_field')

    def test_positive_small_integer_field(self):
        self.check_field('positive_small_integer_field')
