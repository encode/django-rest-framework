...
class ManyToManyTargetSerializer(serializers.HyperlinkedModelSerializer):
    sources = serializers.ManyHyperlinkedRelatedField(
...
class HyperlinkedManyToManyTests(TestCase):
    ...
    def test_reverse_many_to_many_update(self):
        data = {'url': '/manytomanytarget/1/', 'name': u'target-1',
    ...
    def test_reverse_many_to_many_create(self):
        ...
        expected = [
            ...
            {'url': '/manytomanytarget/3/', 'name':
                u'target-3', 'sources': ['/manytomanysource/3/']},
            {'url': '/manytomanytarget/4/', 'name': u'target-4',
             'sources': ['/manytomanysource/1/', '/manytomanysource/3/']}
        ]
        self.assertEquals(serializer.data, expected)
...
class HyperlinkedForeignKeyTests(TestCase):
    ...
    def test_foreign_key_retrieve(self):
        ...
        expected = [
            {'url': '/foreignkeysource/1/', 'name':
                u'source-1', 'target': '/foreignkeytarget/1/'},
            {'url': '/foreignkeysource/2/', 'name':
    ...
    def test_reverse_foreign_key_retrieve(self):
        ...
        expected = [
            {'url': '/foreignkeytarget/1/', 'name': u'target-1',
    ...
    def test_foreign_key_update(self):
        data = {'url': '/foreignkeysource/1/', 'name': u'source-1',
        ...
        expected = [
            {'url': '/foreignkeysource/1/', 'name':
                u'source-1', 'target': '/foreignkeytarget/2/'},
            {'url': '/foreignkeysource/2/', 'name':
                u'source-2', 'target': '/foreignkeytarget/1/'},
            {'url': '/foreignkeysource/3/', 'name':
                u'source-3', 'target': '/foreignkeytarget/1/'}
    ...
    def test_reverse_foreign_key_update(self):
        ...
        serializer = ForeignKeyTargetSerializer(queryset)
        expected = [
            {'url': '/foreignkeytarget/1/', 'name':
                u'target-1', 'sources': ['/foreignkeysource/2/']},
            {'url': '/foreignkeytarget/2/', 'name': u'target-2',
             'sources': ['/foreignkeysource/1/', '/foreignkeysource/3/']},
        ]
        self.assertEquals(serializer.data, expected)

    def test_foreign_key_create(self):
        data = {'url': '/foreignkeysource/4/', 'name': u'source-4',
                'target': '/foreignkeytarget/2/'}
    ...
    def test_reverse_foreign_key_create(self):
        data = {'url': '/foreignkeytarget/3/', 'name': u'target-3',
                'sources': ['/foreignkeysource/1/', '/foreignkeysource/3/']}
        ...
        expected = [
            ...
            {'url': '/foreignkeytarget/2/', 'name':
                u'target-2', 'sources': []},
            {'url': '/foreignkeytarget/3/', 'name': u'target-3',
             'sources': ['/foreignkeysource/1/', '/foreignkeysource/3/']},
        ]
        self.assertEquals(serializer.data, expected)
...
class HyperlinkedNullableForeignKeyTests(TestCase):
    ...
    def test_foreign_key_retrieve_with_null(self):
        ...
        expected = [
            {'url': '/nullableforeignkeysource/1/', 'name':
                u'source-1', 'target': '/foreignkeytarget/1/'},
            {'url': '/nullableforeignkeysource/2/', 'name':
                u'source-2', 'target': '/foreignkeytarget/1/'},
    ...
    def test_foreign_key_create_with_valid_null(self):
        data = {'url': '/nullableforeignkeysource/4/', 'name':
    ...
    def test_foreign_key_update_with_valid_null(self):
        data = {'url': '/nullableforeignkeysource/1/', 'name':
...
class HyperlinkedNullableOneToOneTests(TestCase):
    ...
    def test_reverse_foreign_key_retrieve_with_null(self):
        ...
        expected = [
            {'url': '/onetoonetarget/1/', 'name': u'target-1',
                'nullable_source': '/nullableonetoonesource/1/'},
