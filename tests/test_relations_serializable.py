...
# ManyToMany
class ManyToManyTargetRepresentationSerializer(serializers.ModelSerializer):
    class Meta:
        model = ManyToManyTarget
        fields = ('id', 'name')


class ManyToManySourceRepresentationSerializer(serializers.ModelSerializer):
    class Meta:
...
class ManyToManyTargetSerializer(serializers.ModelSerializer):
    sources = serializers.SerializableRelatedField(
...
class ManyToManySourceSerializer(serializers.ModelSerializer):
    targets = serializers.SerializableRelatedField(
...
# ForeignKey
class ForeignKeySourceRepresentationSerializer(serializers.ModelSerializer):
    class Meta:
        model = ForeignKeySource
        fields = ('id', 'name')


class ForeignKeyTargetRepresentationSerializer(serializers.ModelSerializer):
    class Meta:
...
class ForeignKeySourceSerializer(serializers.ModelSerializer):
    target = serializers.SerializableRelatedField(
...
class NullableOneToOneTargetSerializer(serializers.ModelSerializer):
    nullable_source = serializers.SerializableRelatedField(
        serializer_class=ForeignKeyTargetRepresentationSerializer,
        allow_null=True
    )
...
class SerializableManyToManyTests(TestCase):
    ...
    def test_many_to_many_update(self):
        ...
        serializer.save()
        expected = {'id': 1, 'name': 'source-1', 'targets': [{'id':1, 'name': 'target-1'}, {'id': 2, 'name': 'target-2'}, {'id': 3, 'name': 'target-3'}]}
        self.assertEqual(serializer.data, expected)
        ...
        serializer = ManyToManySourceSerializer(queryset, many=True)
        expected = [
            {'id': 1, 'name': 'source-1', 'targets': [{'id': 1, 'name': 'target-1'}, {'id': 2, 'name': 'target-2'}, {'id': 3, 'name': 'target-3'}]},
            {'id': 2, 'name': 'source-2', 'targets': [{'id': 1, 'name': 'target-1'}, {'id': 2, 'name': 'target-2'}]},
            {'id': 3, 'name': 'source-3', 'targets': [{'id': 1, 'name': 'target-1'}, {'id': 2, 'name': 'target-2'}, {'id': 3, 'name': 'target-3'}]}
        ]
        self.assertEqual(serializer.data, expected)
    ...
    def test_reverse_many_to_many_update(self):
        ...
        self.assertTrue(serializer.is_valid())
        serializer.save()
        expected = {'id': 1, 'name': 'target-1', 'sources': [{'id': 1, 'name': 'source-1'}]}
        self.assertEqual(serializer.data, expected)
        ...
        expected = [
            ...
            {'id': 2, 'name': 'target-2', 'sources': [{'id': 2, 'name': 'source-2'}, {'id': 3, 'name': 'source-3'}]},
            {'id': 3, 'name': 'target-3', 'sources': [{'id': 3, 'name': 'source-3'}]}
        ]
        self.assertEqual(serializer.data, expected)
    ...
    def test_many_to_many_create(self):
        ...
        self.assertTrue(serializer.is_valid())
        obj = serializer.save()
        expected = {'id': 4, 'name': 'source-4', 'targets': [{'id': 1, 'name': 'target-1'}, {'id': 3, 'name': 'target-3'}]}
        self.assertEqual(serializer.data, expected)
        ...
        serializer = ManyToManySourceSerializer(queryset, many=True)
        expected = [
            {'id': 1, 'name': 'source-1', 'targets': [{'id': 1, 'name': 'target-1'}]},
            {'id': 2, 'name': 'source-2', 'targets': [{'id': 1, 'name': 'target-1'}, {'id': 2, 'name': 'target-2'}]},
            {'id': 3, 'name': 'source-3', 'targets': [{'id': 1, 'name': 'target-1'}, {'id': 2, 'name': 'target-2'}, {'id': 3, 'name': 'target-3'}]},
            {'id': 4, 'name': 'source-4', 'targets': [{'id': 1, 'name': 'target-1'}, {'id': 3, 'name': 'target-3'}]},
        ]
        self.assertEqual(serializer.data, expected)
    ...
    def test_reverse_many_to_many_create(self):
        ...
        self.assertTrue(serializer.is_valid())
        obj = serializer.save()
        expected = {'id': 4, 'name': 'target-4', 'sources': [{'id': 1, 'name': 'source-1'}, {'id': 3, 'name': 'source-3'}]}
        self.assertEqual(serializer.data, expected)
        ...
        serializer = ManyToManyTargetSerializer(queryset, many=True)
        expected = [
            {'id': 1, 'name': 'target-1', 'sources': [{'id': 1, 'name': 'source-1'}, {'id': 2, 'name': 'source-2'}, {'id': 3, 'name': 'source-3'}]},
            {'id': 2, 'name': 'target-2', 'sources': [{'id': 2, 'name': 'source-2'}, {'id': 3, 'name': 'source-3'}]},
            {'id': 3, 'name': 'target-3', 'sources': [{'id': 3, 'name': 'source-3'}]},
            {'id': 4, 'name': 'target-4', 'sources': [{'id': 1, 'name': 'source-1'}, {'id': 3, 'name': 'source-3'}]}
        ]
        self.assertEqual(serializer.data, expected)
...
class SerializableForeignKeyTests(TestCase):
    ...
    def test_foreign_key_update(self):
        ...
        self.assertTrue(serializer.is_valid())
        serializer.save()
        expected = {'id': 1, 'name': 'source-1', 'target': {'id': 2, 'name': 'target-2'}}
        self.assertEqual(serializer.data, expected)
        ...
        serializer = ForeignKeySourceSerializer(queryset, many=True)
        expected = [
            {'id': 1, 'name': 'source-1', 'target': {'id': 2, 'name': 'target-2'}},
            {'id': 2, 'name': 'source-2', 'target': {'id': 1, 'name': 'target-1'}},
            {'id': 3, 'name': 'source-3', 'target': {'id': 1, 'name': 'target-1'}}
        ]
        self.assertEqual(serializer.data, expected)
    ...
    def test_reverse_foreign_key_update(self):
        ...
        serializer = ForeignKeyTargetSerializer(queryset, many=True)
        expected = [
            {'id': 1, 'name': 'target-1', 'sources': [{'id': 2, 'name': 'source-2'}]},
            {
                'id': 2,
                'name': 'target-2',
                'sources': [{'id': 1, 'name': 'source-1'}, {'id': 3, 'name': 'source-3'}]
            },
        ]
        self.assertEqual(serializer.data, expected)
    ...
    def test_foreign_key_create(self):
        ...
        self.assertTrue(serializer.is_valid())
        obj = serializer.save()
        expected = {'id': 4, 'name': 'source-4', 'target': {'id': 2, 'name': 'target-2'}}
        self.assertEqual(serializer.data, expected)
        self.assertEqual(obj.name, 'source-4')
        ...
        expected = [
            ...
            {'id': 2, 'name': 'source-2', 'target': {'id': 1, 'name': 'target-1'}},
            {'id': 3, 'name': 'source-3', 'target': {'id': 1, 'name': 'target-1'}},
            {'id': 4, 'name': 'source-4', 'target': {'id': 2, 'name': 'target-2'}},
        ]
        self.assertEqual(serializer.data, expected)
...
class SerializableNullableOneToOneTests(TestCase):
    ...
    def test_reverse_foreign_key_retrieve_with_null(self):
        ...
        expected = [
            ...
            {'id': 2, 'name': 'target-2', 'nullable_source': {'id': 1, 'name': 'source-1'}},
        ]
        self.assertEqual(serializer.data, expected)
