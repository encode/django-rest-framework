...
class AdminRendererTests(TestCase):
    ...
    def test_render_dict(self):
        ...
        response.render()
        self.assertContains(
            response, "<tr><th>Foo</th><td>a string</td></tr>", html=True
        )
    ...
    def test_render_dict_with_items_key(self):
        ...
        response.render()
        self.assertContains(
            response, "<tr><th>Items</th><td>a string</td></tr>", html=True
        )
    ...
    def test_render_dict_with_iteritems_key(self):
        ...
        response.render()
        self.assertContains(
            response, "<tr><th>Iteritems</th><td>a string</td></tr>", html=True
        )
